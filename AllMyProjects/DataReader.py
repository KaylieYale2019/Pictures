...
# plt.hist(subjectivityList, bins=[-1.1, -0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75, 1.1])
#
# # Set the x and y labels.
...
wordsToFilter = ["about", "https", "www", "com", "org", "edu", "fail"]
filteredDictionary = dict()

for word in tweetBlob2.words:
    #skip short words that are < 2 chara long
    if len(word) <= 2:
        continue
